...
PublicFolderMailboxesAlreadyExistTitleError = Public Folder mailboxes already exist. You must remove the all existing Public Folder mailboxes before continuing. Please, make sure the mailboxes are empty before removing them.
